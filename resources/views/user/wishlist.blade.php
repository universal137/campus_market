...
<div class="bg-[#F9FAFB] min-h-screen">
    ...
    <div class="bg-white border-b border-gray-100">
        <div class="max-w-7xl mx-auto px-4 py-12">
            <h1 class="text-4xl md:text-5xl font-bold text-gray-900 text-center">我的心愿单</h1>
        </div>
    </div>
    ...
    <div class="max-w-7xl mx-auto px-4 py-8">
        <div class="flex justify-center mb-8">
            <div class="inline-flex bg-gray-100 rounded-full p-1 shadow-inner" role="tablist">
                <button 
                    id="tab-btn-products"
                    onclick="switchTab('products')"
                    class="px-6 py-2.5 rounded-full font-medium text-sm transition-all duration-200 ease-in-out tab-button active"
                    role="tab"
                    aria-selected="true"
                >
                    心仪好物
                ...
                <button 
                    ...
                    class="px-6 py-2.5 rounded-full font-medium text-sm transition-all duration-200 ease-in-out tab-button"
                    role="tab"
                    aria-selected="false"
                >
                    关注任务
        ...
        <div id="tab-products" class="tab-content">
            @if($wishlistProducts->isEmpty())
                <div class="text-center py-20">
                    <div class="inline-block p-8 bg-white rounded-2xl border border-gray-100 shadow-sm mb-6">
                        <svg class="w-20 h-20 text-gray-300 mx-auto mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z"></path>
                        </svg>
                        <p class="text-gray-500 text-lg mb-2">暂无收藏</p>
                        <p class="text-gray-400 text-sm mb-6">快去发现心仪好物吧</p>
                        <a 
                        ...
                        <div class="product-card-entry opacity-0 translate-y-8 transition-all duration-700 ease-out transform">
                            <article class="bg-white rounded-3xl overflow-hidden border border-gray-100 shadow-sm transition-all duration-300 ease hover:-translate-y-1 hover:shadow-[0_8px_24px_rgba(0,0,0,0.1)] hover:border-slate-300 relative group">
                                ...
                                <div class="aspect-[4/3] bg-gray-100 overflow-hidden relative">
                                    ...
                                    <!-- Heart Button (Top-Right) - Always Red (in wishlist) -->
                                    <button 
                                        type="button"
            ...
            @if($wishlistTasks->isEmpty())
                <div class="text-center py-20">
                    <div class="inline-block p-8 bg-white rounded-2xl border border-gray-100 shadow-sm mb-6">
                        ...
                        <p class="text-gray-500 text-lg mb-2">暂无关注</p>
                        <p class="text-gray-400 text-sm mb-6">快去发现有趣的互助任务吧</p>
                        <a 
